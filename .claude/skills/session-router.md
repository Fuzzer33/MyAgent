...
1. Read `vault/learner-profile.md` to load the user's profile, domains, equipment, skill levels, and tutor persona.
2. Greet the user using the configured `tutor_persona` tone:
...
3. Check `vault/inbox.md` for pending items. If there are pending items, briefly mention them as options.
